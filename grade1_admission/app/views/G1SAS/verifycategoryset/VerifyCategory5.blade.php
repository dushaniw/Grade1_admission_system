        	    ...
        	    <div class = "panel panel-primary panel-transparent">
					...
					<div id="category5">
						<div class="form-group">
							...
							{{ Form:: text( 'dateOfTransferReceived',$category->getDateOfTransferReceived(), array('class' =>'form-control','style'=>'width: 150px; background-color:white','readonly')) }}	
						</div>
						<div class="form-group">
							{{Form::label('Label42','Name & address of work place before receiving the transfer')}}
							{{Form:: text( 'beforeWorkedPlace',$category->getBeforeWorkedPlace(),array('class' =>'form-control','style'=>'background-color:white','readonly'))  }}		
						</div>
						<div class="form-group">
							{{Form::label('Label43', 'Name & address of work place after receiving the transfer')}}
							{{Form:: text( 'afterWorkedPlace',$category->getAfterWorkedPlace(),array('class' =>'form-control','style'=>'background-color:white','readonly'))}}
						</div>
						<div class="form-group">
							{{Form::label('Label44','c) Distance between the earlier place of work and place arrived on transfer (in km)')}}
							{{Form:: text( 'distanceOfTransfer',$category->getDistanceOfTransfer()." km",array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly')) }}	

						</div>
						<div class="form-group">
							{{Form::label('Label46','e) Period of service as a State/Corporation/Statutory Bank/State Bank employee')}}		
		 					{{Form:: text( 'servicePeriod',$category->getServicePeriod(),array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly')) }}
						</div>
						<div class="form-group">
					...
					{{ Form:: open(array('url' =>'school/cancelverify','method' => 'POST'))}}
						...
						{{Form::submit('Back',array('class' => 'btn btn-primary','style'=>'position:absolute; right:450px; top:1663px ' ))}}
					{{Form::close()}}
