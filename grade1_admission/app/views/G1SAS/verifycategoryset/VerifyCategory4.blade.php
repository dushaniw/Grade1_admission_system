                    ...
                    <div class = "panel-body"> <div class = "col-md-10">
						...
						<div id="catogory4" >
							<div class="form-group">
								...
								{{ Form:: text( 'permenentEmployeePost',$category->getPermenentEmployeePost(),array('class' =>'form-control','style'=>'width: 300px; background-color:white','readonly') )  }}	
							 </div>
							<div class="form-group">
								{{Form::label('Label31', 'b) Distance from place of residence to place of work')}}
		 						{{Form:: text( 'distanceFromResidentToWork',$category->getDistanceFromResidentToWork()." km", array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))  }}	
							</div>
							<div class="form-group">
								...
								@if($category->getNowInDifficultSchoolService())
		 							{{Form:: text( 'nowInDifficultSchoolService','Yes',array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))}}		
								@else
									{{Form:: text( 'nowInDifficultSchoolService','No', array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))}}	
								@endif
							
							</div>
							<div class="form-group">
								{{Form::label('Label33','d) If served earlier in a in a difficult school such period of service')}}		
		 						{{Form:: text( 'periodInDifficultSchoolService',$category->getPeriodOfDifficultSchoolService()." years",  array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))  }}
							
							</div>
							<div class="form-group">
								{{Form::label('Label40','Currently Serving School:')}}		
		 						{{Form:: text( 'servingPeriodOfSchool',$cur_school->getSchool_name(),array('class' =>'form-control','style'=>' background-color:white','readonly')) }}		
							</div>
							<div class="form-group">
								{{Form::label('Label40','Period of service in this school:')}}		
								{{Form:: text( 'servingPeriodOfSchool',$category->getServingPeriodOfSchool(), array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))  }}
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								{{ Form:: text( 'year1RemLeaveText',$category->getYear1RemLeave()." days", array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly')) }}
							
							</div>
							<div class="form-group">
									{{ Form:: label( 'year2RemLeave','Year 2 :')  }}	
									{{ Form:: text( 'year2RemLeaveText',$category->getYear2RemLeave()." days",array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly')) }}		
							
							</div>
							<div class="form-group">
									{{Form:: label( 'year3RemLeave','Year 3 :') }}		
									{{Form:: text( 'year3RemLeaveText',$category->getYear3RemLeave()." days", array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly')) }}	
							
							</div>
							<div class="form-group">
								{{ Form:: label( 'year4RemLeave','Year 4 :') }}			
								{{ Form:: text( 'year4RemLeaveText',$category->getYear4RemLeave()." days", array('class' =>'form-control','style'=>'width: 100px; background-color:white','readonly'))  }}
						...
						{{ Form:: open(array('url' =>'school/cancelverify','method' => 'POST'))}}
							...
							{{Form::submit('Back',array('class' => 'btn btn-primary','style'=>'position:absolute; right:450px; top:1810px ' ))}}
						{{Form::close()}}
