        	...
        	<div class = "col-md-9">
        	    <div class = "panel panel-primary panel-transparent">
                    ...
                    <div class = "panel-body"> <div class = "col-md-10">
						...
						<div id="catogory6" >
							<div class="form-group">
								...
								{{Form:: text( 'dateOfReturned',$category->getDateOfReturned(),array('class' =>'form-control','style'=>'width: 150px; background-color:white','readonly'))  }}		
							</div>
							<div class="form-group">
								{{Form::label('Label7','b) Period of stay abroad')}}
								{{Form::text( 'PeriodOfStayAbroad',$category->getPerioadAbroadStay()." years",array('class' =>'form-control','style'=>'width: 150px; background-color:white','readonly')) }}	

							</div>
							<div class="form-group">
								{{Form::label('Label8', 'c) Reason for stay :');}}
								@if($category->getReasonsForStay()==1)
									{{Form::text('labler1', 'On Sri lankan dutha mandala duty',array('class' =>'form-control','style'=>'background-color:white','readonly'))}}
								@elseif($category->getReasonsForStay()==2)
									{{Form::text('labelr2', 'On Sri lankan goverment duty purpose', array('class' =>'form-control','style'=>'background-color:white','readonly'))}}
        						@elseif($category->getReasonsForStay()==3)
        							{{Form::text('labelr3', 'Scholarship ',array('class' =>'form-control','style'=>'background-color:white','readonly'))}}
        						@elseif($category->getReasonsForStay()==4)
        							{{Form::text('labelr4', 'Personal Reason',array('class' =>'form-control','style'=>'background-color:white','readonly'))}}
       						    @endif
							</div>
							<div class="form-group">
					...
					{{ Form:: open(array('url' =>'school/cancelverify','method' => 'POST'))}}
						...
						{{Form::submit('Back',array('class' => 'btn btn-primary','style'=>'position:absolute; right:450px; top:1184px ' ))}}
					{{Form::close()}}
